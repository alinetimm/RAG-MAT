...
def extract_text_from_pdf_url(url, output_filename="output.txt"):
...
def process_pdf(text):
    ...
    try:
        ...
        paragraphs = text.split('. ')  # Divisão inicial por parágrafos
        logging.info(f"Número inicial de parágrafos extraídos: {len(paragraphs)}")

        # Processa cada parágrafo, removendo espaços e adicionando como chunks
